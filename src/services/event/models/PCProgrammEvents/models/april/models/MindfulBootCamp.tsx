...
/**
 * Mindful Boot Camp lobby PC program event at Iwatodai Dormitory.
 */
...
/**
 * Lobby PC program that runs "Mindful Boot Camp" at the Iwatodai Dormitory.
 *
 * Grants Max SP Boost. Availability is inherited from {@link LobbyPCProgramsAprilBase}.
 */
export class MindfulBootCampPCEvent extends LobbyPCProgramsBase {
  /** Discriminator used to identify the event type during serialization. */
  static readonly name = LobbyPCProgramsAprilNames.mindfulBootCamp;
      ...
      <Card
        ...
        body={
          <>
            ...
            <ModifiersRow modifiers={['Max SP Boost']} />
          </>
        }
        header={this.name}
      />
