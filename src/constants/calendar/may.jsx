    ...
    activities: {
      morning: {
        ...
        label: () => (
          ...
          >
            <Choice label="A pantograph." correct />
      ...
      morning: {
        ...
        label: () => (
          <Choices label={"Which tool did he use in his experiments?"}>
            <Choice label="The Pendulum." correct />
          </Choices>
        ),
      },
      day: events.HangedMan,
    ...
    activities: {
      morning: {
        ...
        label: () => (
          ...
          >
            <Choice label="May Blues." correct />
          </Choices>
        ),
      },
      day: events.Hierophant,
    ...
    activities: {
      morning: {
        ...
        label: () => (
          ...
          >
            <Choice label="A pendulum" correct />
          </Choices>
        ),
      },
      day: events.special,
    ...
    activities: {
      morning: {
        ...
        label: () => (
          ...
          >
            <Choice label="Electricity" correct />
          </Choices>
        ),
      },
      day: events.special,
