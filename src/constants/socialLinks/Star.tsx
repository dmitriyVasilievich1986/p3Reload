      ...
      [Routes.Platonic]: QuestionsWrapper({
        ...
        element: [
          <Question label="...All right, just one more!">
            ...
            <Answer label="Enjoy your food." points={5} />
          </Question>,
    ...
    4: {
      [Routes.Platonic]: QuestionsWrapper({
        ...
        element: [
          ...
          <Question label="I used to come here a lot with my teammates, but...">
      ...
      [Routes.Platonic]: QuestionsWrapper({
        ...
        element: [
          ...
          <Question label="In the end, maybe it was my fault the team couldn't work together.">
            <Answer label="It sure was." points={15} />
            <Answer label="Don't sweat it." points={15} />
          </Question>,
        ],
      }),
    },
